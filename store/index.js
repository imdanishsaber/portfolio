...
export const state = () => ({
  ...
  projects: [
      ...
      socialSharings: [
        {
          ...
          name: "Twitter",
          icon: "twitter",
          url: "https://twitter.com/imdanishsaber",
        },
        {
          id: uuidv4(),
          name: "Instagram",
          icon: "instagram",
          url: "https://instagram.com/imdanishsaber",
        },
        {
          id: uuidv4(),
          name: "Facebook",
    ...
    },
    {
      ...
      title: "Lads Minting & Staking",
      category: "Staking Application",
  ...
  aboutMe: [
    ...
    {
      id: uuidv4(),
      bio: "Developed 100+ Web3 and Dapps projects over fiverr and upwork for my client’s, with 5 start rating over all. The client was extremely pleased with my understanding of web3 integration."
    },
  ],
  ...
  socialProfiles: [
    ...
    },
    {
      ...
      name: "GitHub",
      icon: "github",
      url: "https://github.com/imdanishsaber",
    },
    {
      id: uuidv4(),
      name: "Twitter",
    ...
    },
    {
      ...
      name: "mail",
      icon: "mail",
      url: "mailto:imdanishsaber@gmail.com",
    },
  ],
  categories: [
    {
